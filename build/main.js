...
var _user$project$Main$init = function (_p0) {
	var _p1 = _p0;
	return {ctor: '_Tuple2', _0: _p1.now, _1: _elm_lang$core$Platform_Cmd$none};
};
...
var _user$project$Main$elmConfEndTime = A2(
	_elm_lang$core$Result$withDefault,
	0,
	A2(
		_elm_lang$core$Result$map,
		_elm_lang$core$Date$toTime,
		_elm_lang$core$Date$fromString('2016-09-15T17:00:00-05:00')));
var _user$project$Main$elmConfStartTime = A2(
	_elm_lang$core$Result$withDefault,
	0,
	A2(
		_elm_lang$core$Result$map,
		_elm_lang$core$Date$toTime,
		_elm_lang$core$Date$fromString('2016-09-15T09:00:00-05:00')));
var _user$project$Main$view = function (model) {
	return ((_elm_lang$core$Native_Utils.cmp(model, _user$project$Main$elmConfStartTime) > -1) && (_elm_lang$core$Native_Utils.cmp(model, _user$project$Main$elmConfEndTime) < 1)) ? A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('ELM CONF IS NOW')
			])) : ((_elm_lang$core$Native_Utils.cmp(model, _user$project$Main$elmConfEndTime) > 0) ? A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Elm Conf already happened :( See you next year!')
			])) : A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Main$subscriptions = function (model) {
	return (_elm_lang$core$Native_Utils.cmp(model, _user$project$Main$elmConfStartTime) < 0) ? A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Main$Tick) : _elm_lang$core$Platform_Sub$none;
};
